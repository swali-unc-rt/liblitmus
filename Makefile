...
flags-api      = -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -DCONFIG_LITMUS_LOCKING_SMLP -DCONFIG_LITMUS_LOCKING_WITHARGS -DCONFIG_LITMUS_LOCKING_OMLP -DCONFIG_LITMUS_ENABLE_RELEASEGROUPS
